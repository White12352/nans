...
awk '{if(index($0, "//replace github.com/sagernet/sing") > 0) $0 = "replace github.com/sagernet/sing v0.2.18-0.20231108041402-4fbbd193203c => ../sing"}1' sing-box/go.mod > temp_file && mv -f temp_file sing-box/go.mod
